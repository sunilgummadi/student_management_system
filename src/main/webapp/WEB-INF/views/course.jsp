...
<div align="center">
    ...
    <h3><a href="${contextPath}/newcourse">New Course</a></h3>
    <table  class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td>${student.courseurl}</td>
            <td>
                <a href="${contextPath}/editc?id=${student.id}">Edit</a>
                &nbsp;&nbsp;&nbsp;
                <a href="${contextPath}/deletec?id=${student.id}">Delete</a>
            </td>
        </tr>
        </c:forEach>
    </table>
