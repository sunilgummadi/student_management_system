      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-3 text-right">
            <a href="<c:url value='/login' />" class="small btn btn-primary px-4 py-2 rounded-0"> Logout</a>
          </div>
        </div>
      </div>
    </div>
...
<header class="site-navbar  js-sticky-header site-nav-target" role="banner" style="margin-top:0px;" >
      <div class="container">
...
<div align="center" class="position-relative" style="padding-top: 70px;">
   ...
   <!--  <form method="get" action="search">
    ...
    <h3><a href="${contextPath}/newbranch">Users Table</a></h3>
    <table  class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td>
                <a href="${contextPath}/editb?id=${branch.id}">Edit</a>
                &nbsp;&nbsp;&nbsp;
                <a href="${contextPath}/deleteb?id=${branch.id}">Delete</a>
            </td>
        </tr>
        </c:forEach>
    </table>
